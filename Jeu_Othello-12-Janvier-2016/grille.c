	...
	// 	
		...
		switch(evenement.type) {
			case SDL_QUIT:
				...
				break;
			case SDL_KEYDOWN:
				i_chiffre_saisie=evenement.key.keysym.sym-37;
				printf ("Le nombre saisi est : %i \n", i_chiffre_saisie);
			...
			if( SDL_Flip( screen ) == -1 ) { 
				...
				return 1; 
						...
						return 2;
						break;
					case SDLK_3: //touche 3
            					i_continuer_saisie = 0;
						return 3;
						break;
					case SDLK_4: //touche 4
            					i_continuer_saisie = 0;
						return 4;
						break;
					case SDLK_5: //touche 5
            					i_continuer_saisie = 0;
						return 5;
						break;
					case SDLK_6: //touche 6
            					i_continuer_saisie = 0;
						return 6;
						break;
					case SDLK_7: //touche 7
            					i_continuer_saisie = 0;
						return 7;
						break;
					case SDLK_8: //touche 8
            					i_continuer_saisie = 0;
						return 8;
						break;
					case SDLK_9: //touche 9
            					i_continuer_saisie = 0;
						return 9;
						break;
					default :

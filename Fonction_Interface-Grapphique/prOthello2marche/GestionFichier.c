...
{
	//retourn 1 si l'utilisateur à charger une partie 0 sinon
	...
	//  affichage 1er commande
	sprintf(phrase2_affiche, " entrez 6 pour avancer ");
	position.x = 520;
	position.y = 110;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	
		//  affichage commande 2
	sprintf(phrase2_affiche, " entrez 4 pour reculer ");
	position.x = 520;
	position.y = 130;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);

	//  affichage commande 3
	sprintf(phrase2_affiche, " entrez 2 pour aller à la fin ");
	position.x = 520;
	position.y = 150;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	
	//  affichage commande 4
	sprintf(phrase2_affiche, " entrez 8 pour revenir au début ");
	position.x = 520;
	position.y = 170;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	
	//  affichage commande 5
	sprintf(phrase2_affiche, " entrez 5 pour charger ");
	position.x = 520;
	position.y = 190;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	
	//  affichage commande 6
	sprintf(phrase2_affiche, " entrez -1 pour quitter ");
	position.x = 520;
	position.y = 210;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	
	//  affichage validation commande
	sprintf(phrase2_affiche, " et terminer par un appui sur entree, merci");
	position.x = 520;
	position.y = 230;
	afficher_message_interface_SDL (screen, message, phrase2_affiche, font, position, textColor, fondColor);
	...
	while (iCommande != -1){
		printf ("\n le icommande est : %i \n", iCommande);
		iCommande = saisie_nombre_interface_SDL();
        switch (iCommande) {
            case 6:
